                ...
                <div class="row no-gutter">
					...
					<div class="col-xs-12 col-sm-2 hidden" id="iz4">
					 <div class="form-group">
						...
						<input name="xx3" id="xx3" size="16" type="text" value="<? if ($_GET["ilanId"] == ""){ echo date("d-m-Y").' 23:00'; } else { echo $v->bitiszamani; } ?>" readonly class="form_datetime form-control">
					</div>
					</div>
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="hidden-xs col-sm-9">
                        <div id="map_canvas" style="width:100%; height:200px; padding:5px; border:solid 1px #ddd"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <input size="20" type="hidden" id="lngbox" name="lng" >
            <input size="20" type="hidden" id="zoom" name="zoom" >
                <input size="20" type="hidden" id="address" name="address" >
                    <cfoutput>
                        <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCJXEZo1q6COd1HdhijSgnbVJ3LQEBXrD8&sensor=false"></script>
                    </cfoutput>
