...
<div class="col-xs-12 col-sm-9" style="padding-left:5px;">
			...
			<div class="panel panel-default">
                <div class="panel-heading">Son 48 Saat İçinde Eklenen İlanlar </div>
                <div class="panel-body">
                    <div class="row no-gutter">
						...
						$sqlsor = $db->query("SELECT * FROM ilanlar WHERE (dates BETWEEN '".$filtre48."' AND '".$bugun."') ORDER BY dates DESC LIMIT 48");
