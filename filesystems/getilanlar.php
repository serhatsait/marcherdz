...
<div class="col-xs-12 col-sm-9" style="padding-left:5px;">
			<div class="panel panel-default">
                <div class="panel-heading">Get ( Güvenli Ticaret ) İlanları</div>
                <div class="panel-body">
                    <div class="row no-gutter">
                        <?
                        $bugun = date("Y-m-d");
                        $sqlsor = $db->query("SELECT * FROM ilanlar WHERE (bitis >= '$bugun') and confirm = '1' and type = '1' ORDER BY Id DESC LIMIT 24");
