...
<div class="container top15">
  <div class="panel panel-default">
    <div class="panel-heading">Firma Ekle / Kategori Seç</div>
    <div class="panel-body"> Aşağıdaki kategorilerden firmnız için en uygun kategoriyi seçiniz.<br>
      <br>
      <select id="cat1" name="cat1" class="form-control" style="max-width: 180px; float:left; font-size:12px" onchange="cat1()" size="10">
      <option value="">Seçiniz</option>
        <?php
                $sql = $db->query("SELECT * FROM category WHERE ustkategoriId = '0' and tip = '1' ORDER BY sira ASC");
...
<div class="container top15">
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="alert alert-danger"><strong>Uyarı!</strong> Maksimum firma / ilan sınırını aştınız daha fazla firma / ilan eklemek için mağaza açmanız gerekmektedir.</div>
    </div>
  </div>
</div>
<? } else { ?>
...
<div class="container top15">
  <div class="panel panel-default">
    <div class="panel-heading">Firma Ekle / Kategori Seç</div>
    <div class="panel-body"> Aşağıdaki kategorilerden firmanız için en uygun kategoriyi seçiniz.<br>
      <br>
