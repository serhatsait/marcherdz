...
?>" method="post">
    <div class="container top15">
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-phone" aria-hidden="true"></i> İletişim Bilgileri</div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="form-group">
                            ...
                            <div style="margin-right:15px !important; padding-right: 0px !important;"><a href="index.php?page=membership" class="btn btn-primary btn-block margin52"><i class="fa fa-exchange" aria-hidden="true"></i> İletişim Bilgilerimi Değiştir</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <br>
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-align-center" aria-hidden="true"></i> İlan Detayları</div>
            <div class="panel-body">
                <div class="form-group">
        ...
        <br>
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-try" aria-hidden="true"></i> Satış & Fiyat & Yayın</div>
            <div class="panel-body">
        ...
        <?
            ...
            <div class="panel-heading"><i class="fa fa-info-circle" aria-hidden="true"></i> Detaylı Bilgi</div>
            <div class="panel-body">
        ...
        <br>
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-picture-o" aria-hidden="true"></i> Fotoğraf</div>
            <div class="panel-body">
                <?php
                if ($_GET["ilanId"] != "") {
                    $ses = $_GET["ilanId"];
        ...
        <br>
        <div class="panel panel-default">
            <div class="panel-heading"><i class="fa fa-map-marker" aria-hidden="true"></i> Adres</div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-3">
                        <div class="form-group">
