...
<div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-star" aria-hidden="true"></i> Anasayfa Vitrini<span class="pull-right"><a href="anasayfa-ilanlari.html">Tümünü Görüntüle</a></span></div>
                <div class="panel-body">
...
margin-left:50px;
			...
			<div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-briefcase" aria-hidden="true"></i> Son Eklenen Firmalar<span class="pull-right"><a href="rehber.html" class="hidden-xs">Tümünü Görüntüle</a></span></div>
        <div class="panel-body">
...
<div style="margin-top:10px; margin-bottom:10px"><? echo banner(3); ?></div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Son Eklenen Mağazalar<span class="pull-right"><a href="magazalar.html" class="hidden-xs">Tümünü Görüntüle</a></span></div>
                <div class="panel-body">
                    <div class="row no-gutter">
                        <?
