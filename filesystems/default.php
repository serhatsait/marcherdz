                    ...
                    <b>
                        ...
                        <div class="subcat_special">
                            <i class="fa fa-shopping-cart" style="color: #20568a;" aria-hidden="true"></i> <a
                                    ...
                                    class="cat_text">Güvenli e-Ticaret İlanları</a>
                            <div style="clear:both"></div>
                        </div>
                        <div class="subcat_special">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row no-gutter son-eklenen">
                        ...
                        <div class="adv2">
                                    <div class="image1">
                                    <a href="i-' . $row["Id"] . '-' . slugify($row["title"]) . '.html" alt="' . $row["title"] . '" title="' . $row["title"] . '"> <div class="acil-box"><img src="' . $src . '" width="93" height="75" alt=""/><div class="box_type" style="margin-top:5px;background: rgba(0,0,0,0.5);color: #fff;border-radius: 4px;font-weight:600;font-size: 12px;-webkit-border-bottom-left-radius: 3px;-moz-border-radius-bottomleft: 3px;border-bottom-left-radius: 3px;">' . number_format($row[price]) . ' ' . $row[exchange] . '</div></div></a></div>
