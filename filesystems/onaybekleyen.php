...
<div class="container top15">
    <div class="row no-gutter">
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="panel panel-default">
                <div class="panel-heading">Alıcı Kargo Onayı Bekleyenler</div>
                <div class="panel-body">
                    <?
                    $uye = $_SESSION["uye"];
                    $sql = $db->query("SELECT * FROM siparisler WHERE satici = '$uye' and durum = '1' ORDER BY Id DESC");
                    if ($sql->rowCount() == 0){
                    echo '<div class="alert alert-danger" style="margin-bottom:0px !important"><strong>Uyarı:</strong> Onay bekleyen satışınız bulunmamaktadır</div>';
                    } else {
                    ?>
