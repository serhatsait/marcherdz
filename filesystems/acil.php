        ...
        <div class="hidden-xs col-sm-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    if (sayac($b->Id) != 0){
                    echo '<li class="sub1"><a href="acil-ilanlar-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span>( ' . sayac($b->Id) . ' )</span></a></li>';
                    }
                    if (sayac($a->Id) != 0){
                    echo '<li class="sub2"><a href="acil-ilanlar-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span>( ' . sayac($a->Id) . ' )</span></a></li>';
                    }
                    $sub = 3;
                    } else {
                    $u    = $b->ustkategoriId;
                    ...
                    if (sayac($c->Id) != 0){
                    echo '<li class="sub1"><a href="acil-ilanlar-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span>( ' . sayac($c->Id) . ' )</span></a></li>';
                    }
                    if (sayac($b->Id) != 0){
                    echo '<li class="sub2"><a href="acil-ilanlar-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span>( ' . sayac($b->Id) . ' )</span></a></li>';
                    }
                    if (sayac($a->Id) != 0){
                    echo '<li class="sub3"><a href="acil-ilanlar-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span>( ' . sayac($a->Id) . ' )</span></a></li>';
                    }
                    $sub = 4;
                    } else {
                    $u    = $c->ustkategoriId;
                    ...
                    if (sayac($d->Id) != 0){
                    echo '<li class="sub1"><a href="acil-ilanlar-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span>( ' . sayac($d->Id) . ' )</span></a></li>';
                    }
                    if (sayac($c->Id) != 0){
                    echo '<li class="sub2"><a href="acil-ilanlar-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span>( ' . sayac($c->Id) . ' )</span></a></li>';
                    }
                    if (sayac($b->Id) != 0){
                    echo '<li class="sub3"><a href="acil-ilanlar-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span>( ' . sayac($b->Id) . ' )</span></a></li>';
                    }
                    if (sayac($a->Id) != 0){
                    echo '<li class="sub4"><a href="acil-ilanlar-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span>( ' . sayac($a->Id) . ' )</span></a></li>';
                    }
                    $sub = 5;
                    } else {
                    $u    = $d->ustkategoriId;
                    ...
                    if (sayac($e->Id) != 0){
                    echo '<li class="sub1"><a href="acil-ilanlar-' . $e->Id . '-' . slugify($e->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $e->kategori_adi . ' <span>( ' . sayac($e->Id) . ' )</span></a></li>';
                    }
                    if (sayac($d->Id) != 0){
                    echo '<li class="sub2"><a href="acil-ilanlar-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span>( ' . sayac($d->Id) . ' )</span></a></li>';
                    }
                    if (sayac($c->Id) != 0){
                    echo '<li class="sub3"><a href="acil-ilanlar-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span>( ' . sayac($c->Id) . ' )</span></a></li>';
                    }
                    if (sayac($b->Id) != 0){
                    echo '<li class="sub4"><a href="acil-ilanlar-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span>( ' . sayac($b->Id) . ' )</span></a></li>';
                    }
                    if (sayac($a->Id) != 0){
                    echo '<li class="sub5"><a href="acil-ilanlar-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span>( ' . sayac($a->Id) . ' )</span></a></li>';
                    }
                    $sub = 6;
                    } else {
                    $u    = $e->ustkategoriId;
                    ...
                    if (sayac($f->Id) != 0){
                    echo '<li class="sub1"><a href="acil-ilanlar-' . $f->Id . '-' . slugify($f->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $f->kategori_adi . ' <span>( ' . sayac($f->Id) . ' )</span></a></li>';
                    }
                    if (sayac($e->Id) != 0){
                    echo '<li class="sub2"><a href="acil-ilanlar-' . $e->Id . '-' . slugify($e->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $e->kategori_adi . ' <span>( ' . sayac($e->Id) . ' )</span></a></li>';
                    }
                    if (sayac($d->Id) != 0){
                    echo '<li class="sub3"><a href="acil-ilanlar-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span>( ' . sayac($d->Id) . ' )</span></a></li>';
                    }
                    if (sayac($c->Id) != 0){
                    echo '<li class="sub4"><a href="acil-ilanlar-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span>( ' . sayac($c->Id) . ' )</span></a></li>';
                    }
                    if (sayac($b->Id) != 0){
                    echo '<li class="sub5"><a href="acil-ilanlar-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span>( ' . sayac($b->Id) . ' )</span></a></li>';
                    }
                    if (sayac($a->Id) != 0){
                    echo '<li class="sub6"><a href="acil-ilanlar-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span>( ' . sayac($a->Id) . ' )</span></a></li>';
                    }
                    $sub = 7;
                    } else {
                    $u    = $f->ustkategoriId;
                    ...
                    if (sayac($g->Id) != 0){
                    echo '<li class="sub1"><a href="acil-ilanlar-' . $g->Id . '-' . slugify($g->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $g->kategori_adi . ' <span>( ' . sayac($g->Id) . ' )</span></a></li>';
                    }
                    if (sayac($f->Id) != 0){
                    echo '<li class="sub2"><a href="acil-ilanlar-' . $f->Id . '-' . slugify($f->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $f->kategori_adi . ' <span>( ' . sayac($f->Id) . ' )</span></a></li>';
                    }
                    if (sayac($e->Id) != 0){
                    echo '<li class="sub3"><a href="acil-ilanlar-' . $e->Id . '-' . slugify($e->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $e->kategori_adi . ' <span>( ' . sayac($e->Id) . ' )</span></a></li>';
                    }
                    if (sayac($d->Id) != 0){
                    echo '<li class="sub4"><a href="acil-ilanlar-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span>( ' . sayac($d->Id) . ' )</span></a></li>';
                    }
                    if (sayac($c->Id) != 0){
                    echo '<li class="sub5"><a href="acil-ilanlar-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span>( ' . sayac($c->Id) . ' )</span></a></li>';
                    }
                    if (sayac($b->Id) != 0){
                    echo '<li class="sub6"><a href="acil-ilanlar-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span>( ' . sayac($b->Id) . ' )</span></a></li>';
                    }
                    if (sayac($a->Id) != 0){
                    echo '<li class="sub7"><a href="acil-ilanlar-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span>( ' . sayac($a->Id) . ' )</span></a></li>';
                    }
                    $sub = 8;
                    }
                    }
                    ...
                    if (sayac($a->Id) != 0){
                    if (sayac($a->Id) != 0){
                    echo '<li class="sub' . $sub . '"><a href="acil-ilanlar-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span>( ' . sayac($a->Id) . ' )</span></a></li>';
                    }
                    }
                    }
                    echo ' </ul></div>';
