...
<div class="container top15">
    <div class="row no-gutter">
        ...
        <div class="col-xs-12 col-sm-9">
            <div class="panel panel-default">
                <div class="panel-heading">Teklif Verdiğiniz İlanlar</div>
                <div class="panel-body">
                    <?
                    $uye = $_SESSION["uye"];
                    $sql = $db->query("SELECT * FROM teklifler WHERE uyeId = '$uye' ORDER BY Id DESC LIMIT 1");
                    if ($sql->rowCount() == 0){
                    echo '<div class="alert alert-danger" style="margin-bottom:0px !important"><strong>Uyarı:</strong> Kazandığınız  ihale bulunmamaktadır</div>';
                    } else {
                    ?>
