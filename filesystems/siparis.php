        ...
        <div class="col-xs-12 col-sm-9">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="adv' . $class . '">
                    <div class="row no-gutter">
                    <div class="hidden-xs col-sm-1"><a href="i-'.$row["Id"].'-'.slugify($row["title"]).'.html"><img src="' . $src . '" class="img-thumbnail" width="100" /></a></div>
                    <div class="col-xs-10 col-sm-9"><strong style="font-size:14px">' . $row["title"] . '</strong>
