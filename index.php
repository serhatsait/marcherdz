                    ...
                    <div class="wrapper">
                        ...
                        <div class="free_ilan" style="flex: 1;display: flex;justify-content: flex-end;">
                            <a href="<?php echo $base_url; ?>index.php?page=add" class="btn btn-dafault button20">
                                <i class="fa fa-plus-square" aria-hidden="true"></i>2 test Déposez gratuitement votre annonce
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-3 hidden-xs">
                        <div class="footer-single useful-links">
                            ...
                            <ul class="list-unstyled">
                                ...
                                ?>
                                <li><a href="iletisim.html">İletişim <i class="fa fa-angle-right pull-right"></i></a>
                                </li>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-3 hidden-xs">
