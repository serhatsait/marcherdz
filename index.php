        ...
        <div class="navbar-header">
            ...
            <? if ($_SESSION['uye'] == "") { ?>
                ...
                <div class="mobil-menuqq">
                    <li><a href="<?php echo $base_url; ?>facebook.php"><i style="margin:5px;color:#fff;"
                                                                          class="fa fa-facebook-square"
                                                                          aria-hidden="true"></i><font
                                    style="color:#fff;font-size:14px;font-family:arial;text-align: center;">Facebook İle
                                Bağlan</font></a></li>
                    <li><a href="<?php echo $base_url; ?>login/"><i style="margin:5px;color:#fff;" class="fa fa-sign-in"
                                                                    aria-hidden="true"></i><font
                                    style="color:#fff;font-size:14px;font-family:arial;text-align: center;">Giriş
                                yap</font></a></li>
                    <li><a href="<?php echo $base_url; ?>register/"><i style="margin:5px;color:#fff;"
                                                                       class="fa fa-user-plus"
                                                                       aria-hidden="true"></i><font
                                    style="color:#fff;font-size:14px;font-family:arial;text-align: center;">Üye
                                Ol</font></a></li>
                    <li><a href="<?php echo $base_url; ?>index.php?page=add"><i style="margin:5px;color:#fff;"
                                                                                class="fa fa-plus-square"
                                                                                aria-hidden="true"></i><font
                                    style="color:#fff;font-size:14px;font-family:arial;text-align: center;">Ücretsiz
                                İlan Ver</font></a></li>
                </div>
