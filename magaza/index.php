...
if(isset($_GET['sess_id']) && $_GET['sess_id']!= "") { session_id($_GET['sess_id']); }
...
<nav class="navbar navbar-default navbar-static-top">
  <div class="container">
    ...
    <div class="visible-xs" style="color: #fff;font-weight:600;margin-top:9px;text-align:center;margin-left:30px;"><a href="<?php echo $base_url; ?>"><img border="0" src="<?php echo $base_url; ?>img/mobillogo.png" width="160" height="34"></a></div>
	</div>
    <div id="navbar" class="navbar-collapse collapse">
    
      <ul class="nav navbar-nav">
        <li><a href="<?php echo $base_url; ?>"><i class="fa fa-home" aria-hidden="true"></i> Anasayfa</a></li>
        <li class="dropdown visible-xs"> <a href="#" class="dropdown-toggle res1" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="glyphicon glyphicon-th-list"></i> Kategoriler <span class="caret"></span></a>
        ...
        <li class="hidden-xs"><a href="<?php echo $base_url; ?>acil-ilanlar.html?sayfa=1"><i class="fa fa-bell-o" aria-hidden="true"></i> Acil İlanlar</a></li>
        <li class="hidden-xs"><a href="<?php echo $base_url; ?>magazalar.html"><i class="fa fa-shopping-bag" aria-hidden="true"></i> Mağazalar</a></li>
		<li class="hidden-xs"><a href="<?php echo $base_url; ?>rehber.html?sayfa=1"><i class="fa fa-building" aria-hidden="true"></i> Firma Rehberi</a></li>
        <? if ($_SESSION['uye'] == "") { ?>
        <li class="visible-xs"><a href="<? echo $base_url; ?>login/"><i class="fa fa-user" aria-hidden="true"></i> <?php echo $lg[2]; ?></a></li>
        <li class="visible-xs"><a href="<? echo $base_url; ?>register/"><i class="fa fa-user-plus" aria-hidden="true"></i> <?php echo $lg[3]; ?></a></li>
        <? } else { ?>
        <li class="dropdown visible-xs"> <a href="#" class="dropdown-toggle res1" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> Bana Özel <span class="caret"></span></a>
          <ul class="dropdown-menu ">
            <?
                                                        $uye = $_SESSION["uye"];
            ...
            <li><a href="<? echo $base_url; ?>index.php?page=favoriilanlarim">Favori İlanlarım</a></li>
            <?
                                                        $uye = $_SESSION["uye"];
      ...
      <ul class="nav navbar-nav hidden-xs" style="margin-left:380px;">
        <? if ($_SESSION['uye'] == "") { ?>
        <li style="margin-right:5px"><a href="<? echo $base_url; ?>login/"><i class="fa fa-user" aria-hidden="true"></i> <?php echo $lg[2]; ?></a></li>
        <li style="margin-right:5px"><a href="<? echo $base_url; ?>register/"><i class="fa fa-user-plus" aria-hidden="true"></i> <?php echo $lg[3]; ?></a></li>
        <? } else { ?>
        <li><a href="#" style="cursor:default; color:#fff"><strong><? echo $lg[9]; ?>;</strong> <? echo $_SESSION['adsoyad']; ?></a> </li>
        <li class="dropdown"> <a href="#" class="dropdown-toggle btn btn-dafault button2" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> Bana Özel <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <?
                                                        $uye = $_SESSION["uye"];
                                                        $sql = $db->query("SELECT * FROM mesajlar WHERE gonderilen = '$uye' and okundu = '0'");
...
<? echo '<img src="'.$base_url.'uploads/'.$si["magazaslider"].'" width="100%" height="250"/>'; ?>
  ...
  <div class="row">
    <div class="col-sm-3">
	  ...
	  <div class="panel panel-default">
        <div class="panel-heading"><i class="fa fa-file-text-o" aria-hidden="true"></i> Mağaza Bilgileri</div>
        <div class="panel-body"><center><? echo '<img src="'.$base_url.'uploads/'.$si["logo"].'" width="180" height="110"/>'; ?></center></div>
		<center><b>Toplam İlan Adeti : </b> <font color="red"><b><? echo $say; ?></b></font></center>
		<center><b>Mağaza Hakkında</b></center>
		<div class="panel-body"><center><? echo $si["aciklama"]; ?></center></div>
		<div class="userbox2">
              <div class="row">
			  <?
			  ...
			  ?>
                ...
                <div class="col-xs-8"><a href="tel:<? echo $row86["telefon"]; ?>"><font size="2" face="Verdana"> +9<? echo $row86["telefon"]; ?></font></a></div>
              </div>
              <hr class="hr">
              <div class="row">
                <div class="col-xs-4 glyphicon glyphicon-phone"><strong><font size="2" face="Verdana"> Cep</font></strong></div>
                <div class="col-xs-8"><a href="tel:<? echo $row86["gsm"]; ?>"><font size="2" face="Verdana"> +9<? echo $row86["gsm"]; ?></font></a></div>
              </div>
            </div>		
        </div>
            ...
            <?
						...
						$id = $_GET["id"];
						 echo '<li class="sub1"><a href="index.php">» Tüm Kategoriler</span></a></li>';
                            ...
                            echo '<li class="sub1"><a href="c-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub2"><a href="c-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span></span></a></li>';
                            $sub = 3;
                            } else {
                            $u    = $b->ustkategoriId;
                            ...
                            echo '<li class="sub1"><a href="c-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub2"><a href="c-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub3"><a href="c-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span></span></a></li>';
                            $sub = 4;
                            } else {
                            $u    = $c->ustkategoriId;
                            ...
                            echo '<li class="sub1"><a href="c-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub2"><a href="c-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub3"><a href="c-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub4"><a href="c-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span></span></a></li>';
                            $sub = 5;
                            } else {
                            $u    = $d->ustkategoriId;
                            ...
                            echo '<li class="sub1"><a href="c-' . $e->Id . '-' . slugify($e->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $e->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub2"><a href="c-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub3"><a href="c-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub4"><a href="c-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub5"><a href="c-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span></span></a></li>';
                            $sub = 6;
                            } else {
                            $u    = $e->ustkategoriId;
                            ...
                            echo '<li class="sub1"><a href="c-' . $f->Id . '-' . slugify($f->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $f->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub2"><a href="c-' . $e->Id . '-' . slugify($e->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $e->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub3"><a href="c-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub4"><a href="c-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub5"><a href="c-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub6"><a href="c-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span></span></a></li>';
                            $sub = 7;
                            } else {
                            $u    = $f->ustkategoriId;
                            $sql7 = $db->query("SELECT * FROM category WHERE Id = '$u'");
                            $g    = $sql7->fetch(PDO::FETCH_OBJ);
                            echo '<li class="sub1"><a href="c-' . $g->Id . '-' . slugify($g->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $g->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub2"><a href="c-' . $f->Id . '-' . slugify($f->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $f->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub3"><a href="c-' . $e->Id . '-' . slugify($e->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $e->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub4"><a href="c-' . $d->Id . '-' . slugify($d->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $d->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub5"><a href="c-' . $c->Id . '-' . slugify($c->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $c->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub6"><a href="c-' . $b->Id . '-' . slugify($b->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $b->kategori_adi . ' <span></span></a></li>';
                            echo '<li class="sub7"><a href="c-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span></span></a></li>';
                            $sub = 8;
                            }
                            }
                            }
                            ...
                            while ($a = $sql->fetch(PDO::FETCH_OBJ)) {
							if (sayac($a->Id) != 0){	
                            echo '<li class="sub' . $sub . '"><a href="c-' . $a->Id . '-' . slugify($a->kategori_adi) . '.html'; if ($_GET['daralt'] != ""){ echo '?'.$urlek.''; } echo '">» ' . $a->kategori_adi . ' <span></span></a></li>';
							}
							}
    ...
    <div class="col-xs-12 col-sm-9" style="padding-left:5px;">
      <div class="panel panel-default">
        <? if ($_GET['page'] == ""){ ?>
        <div class="panel-heading"><i class="fa fa-plus-square-o" aria-hidden="true"></i> Mağaza İlanları</div>
        <? } else {
...
<div class="container">
<div class="row">
<div class="col-sm-3"><div class="footerlogo"><? echo banner(6); ?></div>
...
<li><a href="<? echo $base_url; ?>index.php">Anasayfa <i class="fa fa-angle-right pull-right"></i></a></li>
<li><a href="<? echo $base_url; ?>hakkimizda.html">Hakkımızda <i class="fa fa-angle-right pull-right"></i></a></li>
<li><a href="<? echo $base_url; ?>iletisim.html">İletişim <i class="fa fa-angle-right pull-right"></i></a></li>
</div>
</div>
<div class="col-xs-12 col-sm-3 hidden-xs">
<div class="footer-single useful-links hidden-xs">
...
<ul class="list-unstyled">
<li><a href="<? echo $base_url; ?>doping.html">Doping <i class="fa fa-angle-right pull-right"></i></a></li>
<li><a href="<? echo $base_url; ?>reklam.html">Reklam <i class="fa fa-angle-right pull-right"></i></a></li>
<li><a href="<? echo $base_url; ?>guvenli-alisveris.html">Güvenli Alışveriş Sistemi <i class="fa fa-angle-right pull-right"></i></a></li>
</div>
</div>
<div class="col-xs-12 col-sm-3 hidden-xs">
<div class="footer-single useful-links hidden-xs">
...
<ul class="list-unstyled">
<li><a href="<? echo $base_url; ?>yardim.html">Yardım <i class="fa fa-angle-right pull-right"></i></a></li>
<li><a href="<? echo $base_url; ?>kullanim-sartlari.html">Kullanım Şartları <i class="fa fa-angle-right pull-right"></i></a></li>
<li><a href="<? echo $base_url; ?>gizlilik-politikasi.html">Gizlilik Politikası <i class="fa fa-angle-right pull-right"></i></a></li>
</div>
</div>
</div>
</div>
