...
<h1> GET İşlemleri<small>Alıcı Onayı Bekleyen</small> </h1>
<ol class="breadcrumb">
  <li><a href="index.php"><i class="fa fa-dashboard"></i> Anasayfa</a></li>
  <li class="">GET İşlemleri</li>
  <li class="active">Alıcı Onayı Bekleyen</li>
</ol>
</section>
<section class="content">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Alıcı Onayı Bekleyen</h3>
    </div>
    ...
    <form role="form" action="" method="post">
      <div class="box-body">
        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?
				$sql3 = $db->query("SELECT * FROM siparisler WHERE durum = '1'");
				...
				<tr>
				  ...
				  <a class="btn btn-success btn-sm" href="index.php?page=gonaybekleyen&id='.$c["Id"].'&i=onay" onclick="return onay()">Onayla</a>
				  <a class="btn btn-danger btn-sm" href="index.php?page=gonaybekleyen&id='.$c["Id"].'&i=iptal" onclick="return sor()">İptal</a></td>
                </tr>
				';	
				}
				?>
