...
<h1>Doping Yönetimi<small>Acil Acil Vitrin İlanları</small> </h1>
<ol class="breadcrumb">
  <li><a href="index.php"><i class="fa fa-dashboard"></i> Anasayfa</a></li>
  <li class="active">Acil Acil Vitrin İlanları</li>
   <li class="active">Acil Acil Vitrin İlanları</li>
</ol>
</section>
<section class="content">
  <div class="box box-primary">
    <div class="box-header with-border">
      <h3 class="box-title">Acil Acil Vitrin İlanları</h3>
    </div>
          ...
          <tbody>
            <?
				...
				<tr>
                  ...
                  <td>'.$row["title"].'</td>
				  <td>'.$row["bitis"].'</td>
                  <td><a class="btn btn-default btn-sm" href="'.$gor.'" target="_blank">Görüntüle</a>&nbsp;&nbsp;<a class="btn btn-danger btn-sm" href="acilacilsil.php?id='.$row["Id"].'" target="_blank">Vitrinden Kaldır</a></td>
